    ...
    <head>
        ...
        <nav>
            ...
            <form class="searchcontainer" action="{{ route('home') }}" method="GET">
              ...
              <select name="rating" id="ratingfilter" style="cursor: pointer;">
              ...
              <button type="submit" style="color: white; border: 0px solid transparent; padding: 0.4%; border-radius: 10px; background: linear-gradient(45deg, #44A08D, #093637); cursor:pointer;">Filter</button>
            </form>
